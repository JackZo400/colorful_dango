...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _pickImage() async {
    ...
    await _session!.sendImage(bytes);
...
class _InputBar extends StatelessWidget {
  final TextEditingController ctrl; final FocusNode focusNode; final bool enabled; final void Function(String) onSend; final VoidCallback? onPickImage;
  ...
  @override Widget build(BuildContext context) {
    ...
    return Container(padding: const EdgeInsets.fromLTRB(8, 4, 8, 8),
      ...
      child: SafeArea(child: Row(children: [
        IconButton(icon: const Icon(Icons.image_outlined, size: 22), onPressed: enabled ? onPickImage : null, tooltip: '图片'),
